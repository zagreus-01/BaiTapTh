...
<head>
    <meta charset="UTF-8">
    <title>Admin - Quản lý Category</title>
    ...
    <table class="table table-bordered table-hover bg-white shadow-sm">
        ...
        <c:forEach var="c" items="${categories}">
            <tr class="align-middle text-center">
                <td>${c.id}</td>
                <td>${c.name}</td>
                <td><img src="${pageContext.request.contextPath}/image/${c.img}" class="img-thumbnail" width="70"></td>
                <td>
              ...
              <div class="modal-dialog modal-lg">
                <div class="modal-content">
                  ...
                  <div class="modal-body">
                    ...
                    <p><strong>Ảnh:</strong><br><img src="${pageContext.request.contextPath}/image/${c.img}" class="img-fluid"></p>
                    <p><strong>Trạng thái:</strong> ${c.status ? "Active" : "Inactive"}</p>
                    <p><strong>Tác giả:</strong> ${c.user != null ? c.user.fullname : '---'}</p>
                  </div>
                </div>
              </div>
            </div>
